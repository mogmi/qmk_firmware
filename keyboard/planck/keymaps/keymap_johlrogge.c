...
[_RS] = { /* RAISE */
  {KC_TRNS, NO_EURO, NO_UNDS, NO_LBRC, NO_RBRC, NO_CIRC, KC_EXLM, NO_LESS, NO_GRTR, NO_EQL,  NO_AMP,  NO_PND},
  {KC_TRNS, SV_BSLS, NO_SLSH, NO_LCBR, NO_RCBR, NO_ASTR, NO_QUES, NO_LPRN, NO_RPRN, NO_MINS, NO_COLN, NO_ACUT},
  {KC_TRNS, KC_HASH, NO_DLR,  SV_PIPE, NO_TILD, NO_AT,   NO_PLUS, KC_PERC, NO_QUO2, NO_APOS, NO_SCLN, KC_TRNS},
